package com.conderlong.activiti7;
...
public class MyActivitiApplication  implements CommandLineRunner {
    private Logger logger = LoggerFactory.getLogger(MyActivitiApplication.class);
    @Autowired
